...
class GameScene: SKScene {
    ...
    override func didMove(to view: SKView) {
        ...
        // TITLE LABEL 
           ...
           gameTitleLabel.text = "Choose Your Game"
           gameTitleLabel.fontSize = 70.0
           gameTitleLabel.position = CGPoint(x: frame.midX, y: frame.midY + 100)
           ...
           gameOneButton.position = CGPoint(x: frame.midX - 100, y: frame.midY - 50)
           gameOneButton.zPosition = Layer.ui.rawValue + 1
           gameOneButton.setScale(0.2) // Adjust scale if needed
           ...
           gameTwoButton.position = CGPoint(x: frame.midX + 100, y: frame.midY - 50)
           gameTwoButton.zPosition = Layer.ui.rawValue + 1
           gameTwoButton.setScale(0.2) // Adjust scale if needed
