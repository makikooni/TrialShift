...
class Player3: SKSpriteNode {
    ...
    init() {
        ...
        // Set default texture
        let texture = SKTexture(imageNamed: "avatar3_0") // Call to super.init
        print("Texture size: \(texture.size())")
        ...
        // Set up animation textures
        self.walkTextures = self.loadTextures(atlas: "Chef_3", prefix: "avatar3_", startsAt: 0, stopsAt: 4)
        
        
        self.dieTextures = self.loadTextures(atlas: "Chef_3", prefix: "avatar3_",
                                             startsAt: 5, stopsAt: 5)
